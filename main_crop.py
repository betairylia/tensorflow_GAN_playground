...
from model import generator2_LN as generator
from model import discriminator_shallow as discriminator
...
def train():
    ...
    for epoch in range(0, nb_epochs):
        ...
        for idx in range(0, len(train_imgs), batch_size):
            ...
            batch_imgs = tl.prepro.threading_data(train_imgs[idx:idx + batch_size], fn=crop_sub_imgs_fn)
